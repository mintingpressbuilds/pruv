"""Shared receipt retrieval and formatting for all pruv integrations."""
...
def get_receipt(agent_id: str, client: Any) -> str:
    ...
    Args:
        agent_id: The pi_ address of the agent identity.
        client: A PruvClient instance.

    Returns:
        The self-verifying HTML receipt.
    """
...
def format_receipt(receipt: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"Framework: {receipt.get('agent_type', receipt.get('framework', 'unknown'))}",
